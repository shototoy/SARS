...
export default function Login({ onAuthed }) {
  ...
  return (
    <div className="min-h-screen bg-gray-100 px-4 pt-20 text-gray-900 dark:bg-gray-950 dark:text-gray-100">
          ...
          <div className="p-5">
            ...
            <form onSubmit={handleSubmit(submit)} className="mt-5 space-y-4">
              <div>
                ...
                <input {...register('username', { required: true })} className={inputClassName} placeholder="e.g., student1" />
              </div>
              <div>
